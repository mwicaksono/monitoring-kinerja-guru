				...
				<div class="col-lg-12">
					<section class="panel">
						<header style="font-size:18px" class="panel-heading">
							<i style="margin-right:7px" class="icon-list-alt"></i> Data Penilaian Guru Oleh Orang Tua
							<a href="?module=data_nilai_ortu&act=add">
								<button style="margin-top:-4px" class="btn btn-primary pull-right"><i class="icon-plus icon-white"></i> Tambah</button>
							</a>
							<a href="?module=data_nilai_ortu&act=add_new_guru">
							...
							<div class="adv-table">
								<table class="display table table-striped table-bordered table-hover" id="example">
									...
									<tbody>
										...
										a.id_nilai, a.periode_nilai, a.guru_dinilai, a.ortu_penilai,
								...
								<tr class='gradeX'>
									...
									<td width='100' class='center'>";
										?>
											<a title="Hapus" href="modules/data_nilai_ortu/aksi_data_nilai_ortu.php?mod=data_nilai_ortu&act=delete&id=<?php echo $data['ortu_penilai']; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
				...
				<div class="col-lg-12">
					<section class="panel">
						<header class="panel-heading">
							<i class="icon-edit"></i> Input data penilaian baru <b>(Orang Tua)</b>
						</header>
						<div class="panel-body">
							<form class="form-horizontal" action="modules/data_nilai_ortu/aksi_data_nilai_ortu.php?mod=data_nilai_ortu&act=input" method="POST" name="frmdatanilai">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Orang Tua Penilai</label>
									<div class="col-sm-4">
										<select style="width:387px" type="text" id="ortu_penilai" name="ortu_penilai" class="form-control" required>
											<option value="">-- Pilih Orang Tua --</option>
											<?php
											$sqluser = $db->database_prepare("SELECT id_user, nama FROM tbl_user
                                                                        WHERE level='Orang Tua' ORDER BY nama ASC")->execute();
								...
								<div class="form-group">
									<div class="col-lg-offset-2 col-lg-10">
										...
										<a style="margin-left:10px;width:80px" href="?module=data_nilai_ortu" class="btn btn-white"> Batal</a>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<section class="panel">
						...
						<div class="panel-body">
							<form class="form-horizontal" action="modules/data_nilai_ortu/aksi_data_nilai_ortu.php?mod=data_nilai_ortu&act=input_new_guru" method="POST" name="frmdatanilai">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Orang Tua Penilai</label>
									<div class="col-sm-4">
										<select style="width:387px" type="text" id="guru_penilai" name="ortu_penilai" required>
											<option value="">-- Pilih Orang Tua --</option>
											<?php
											$sqluser = $db->database_prepare("SELECT id_user, nama FROM tbl_user
                                                                        WHERE level='Orang Tua' ORDER BY nama ASC")->execute();
