	...
	?>
				...
				<div class="col-lg-12">
					<section class="panel">
						<header style="font-size:18px" class="panel-heading">
							<i style="margin-right:7px" class="icon-list-alt"></i> Data Penilaian Oleh Guru
							<a href="?module=data_nilai&act=add">
							...
							<div class="adv-table">
								<table class="display table table-striped table-bordered table-hover" id="example">
									...
									<tbody>
										<?php
										$no = 1;
										$sql = $db->database_prepare("SELECT a.id_nilai,a.periode_nilai,a.guru_dinilai,a.guru_penilai,
								...
								<tr class='gradeX'>
									...
									<td width='100' class='center'>
										<a title='Ubah' href='?module=data_nilai&act=edit&id=$data[id_nilai]'>
											<button class='btn btn-primary btn-xs'><i class='icon-pencil'></i> </button>
										</a> ";
										?>
											<a title="Hapus" href="modules/data_nilai/aksi_data_nilai.php?mod=data_nilai&act=delete&id=<?php echo $data['id_nilai']; ?>" onclick="return confirm('Anda yakin ingin menghapus data <?php echo $data['periode']; ?>?');">
				...
				<div class="col-lg-12">
					<section class="panel">
						<header class="panel-heading">
							<i class="icon-edit"></i> Input data penilaian baru <b>(Guru)</b>
						</header>
						<div class="panel-body">
							<form class="form-horizontal" action="modules/data_nilai/aksi_data_nilai.php?mod=data_nilai&act=input" method="POST" name="frmdatanilai">
								...
								<div class="form-group">
									<div class="col-lg-offset-2 col-lg-10">
										...
										<a style="margin-left:10px;width:80px" href="?module=data_nilai" class="btn btn-white"> Batal</a>
									</div>
								</div>
							</form>
						</div>
		...
		case "edit":
			$data = $db->database_fetch_array($db->database_prepare("SELECT a.id_nilai,a.periode_nilai,a.guru_dinilai,
                                                            b.id_periode,b.periode,b.tahun_ajaran,
		...
		?>
			<div class="row">
				<div class="col-lg-12">
					<section class="panel">
						<header class="panel-heading">
							<i class="icon-edit"></i> Ubah data_nilai
						</header>
						<div class="panel-body">
							<form class="form-horizontal" action="modules/data_nilai/aksi_data_nilai.php?mod=data_nilai&act=update" method="POST" name="frmdatanilai">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select style="width:387px" type="text" id="guru_dinilai" name="guru_dinilai" class="">
											<option value="<?php echo $data['guru_dinilai']; ?>"><?php echo $data['nama_guru']; ?>, <?php echo $data['gelar']; ?> (<?php echo $data['guru_dinilai']; ?>)</option>
											<?php
											$sql = $db->database_prepare("  SELECT nip, nama_guru, gelar FROM tbl_guru
                                                                        ORDER BY nama_guru ASC")->execute();
											while ($data = $db->database_fetch_array($sql)) {
								...
								<?php
								$datab = $db->database_fetch_array($db->database_prepare("  SELECT a.id_nilai,a.guru_penilai,
