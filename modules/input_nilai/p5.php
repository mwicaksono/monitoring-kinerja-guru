	...
	?>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="alert alert-info alert-block fade in">
								...
								<p style="font-size:15px">Kompetensi 5 : Memahami dan mengembangkan kompetensi.</p>
							</div>
							<div class="adv-table">
								<table class="display table table-striped table-bordered table-hover" id="example">
									<thead>
										<tr>
											...
											<th colspan="7">Indikator Penilaian</th>
									...
									<tbody>
										...
										$sql = $db->database_prepare("SELECT a.id_nilai,a.periode_nilai,a.guru_dinilai,a.guru_penilai,a.angka_kredit,
                                                          ...
                                                          d.id_pedagogik5,d.np5_indikator1,d.np5_indikator2,d.np5_indikator3,d.np5_indikator4,d.np5_indikator5,d.np5_indikator6,d.np5_indikator7,d.np5_total_skor,d.np5_persentase,d.np5_nilai_kompetensi
                                                          FROM tbl_penilaian AS a
                                                          JOIN tbl_periode AS b
                                                          JOIN tbl_guru AS c
                                                          JOIN pedagogik5 AS d
                                                          ON a.periode_nilai=b.id_periode 
                                                          AND a.guru_dinilai=c.nip
                                                          AND a.id_nilai=d.id_pedagogik5
                                ...
                                <tr class='gradeX'>
                                    ...
                                    <td width='50' class='center'>$data[np5_indikator1]</td>
                                    <td width='50' class='center'>$data[np5_indikator2]</td>
                                    <td width='50' class='center'>$data[np5_indikator3]</td>
                                    <td width='50' class='center'>$data[np5_indikator4]</td>
                                    <td width='50' class='center'>$data[np5_indikator5]</td>
                                    <td width='50' class='center'>$data[np5_indikator6]</td>
                                    <td width='50' class='center'>$data[np5_indikator7]</td>
                                    <td class='center'>$data[np5_total_skor]</td>
                                    <td class='center'>$data[np5_persentase] %</td>
                                    <td class='center'>$data[np5_nilai_kompetensi]</td>";

											if ($data['np5_nilai_kompetensi'] == '0' && $data['angka_kredit'] == '') {
												echo "
                                    <td width='100' class='center'>
                                        <a title='Penilaian' href='?module=p5&act=nilai&id=$data[id_nilai]'>
                                            <button class='btn btn-primary btn-xs'><i class='icon-edit'></i> Nilai</button>
                                        </a> 
                                    </td>";
											} elseif ($data['np5_nilai_kompetensi'] != '0' && $data['angka_kredit'] == '') {
												echo "
                                    <td width='100' class='center'>
                                        <a title='Ubah' href='?module=p5&act=edit&id=$data[id_nilai]'>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<form class="form-horizontal tasi-form" action="modules/input_nilai/aksi_p5.php?mod=p5&act=nilai" method="POST" name="frmP5">
								...
								<div class="form-group">
									<label class="col-sm-10 col-sm-10 control-label">3. Perencanaan pembelajaran dapat memunculkan daya kretivitas dan kemampuan berpikir kritis peserta didik</label>
									<div class="col-sm-2">
								...
								<div class="form-group">
									<label class="col-sm-10 col-sm-10 control-label">3. Pelaksanaan pembelajaran dapat memunculkan daya kretivitas dan kemampuan berpikir kritis peserta didik</label>
									<div class="col-sm-2">
								...
								<div class="form-group">
									<label class="col-sm-10 col-sm-10 control-label">3. Guru merancang dan melaksanakan aktivitas pembelajaran untuk memunculkan daya kretivitas dan kemampuan berpikir kritis peserta didik</label>
									<div class="col-sm-2">
								...
								<div class="form-group">
									<div class="col-sm-2 pull-right">
										...
										<a style="margin-left:10px;width:80px" href="?module=p5" class="btn btn-white"> Batal</a>
									</div>
								</div>
							</form>
						</div>
		...
		case "edit":
			$data = $db->database_fetch_array($db->database_prepare("SELECT a.id_nilai,a.periode_nilai,a.guru_dinilai,a.guru_penilai,
                                                            b.id_periode,b.periode,
                                                            c.nip,c.nama_guru,c.gelar,
                                                            d.id_pedagogik5,d.ap5_point1,d.ap5_point2,d.ap5_point3,d.ap5_point4,d.ap5_point5,d.ap5_point6,d.ap5_point7,d.ap5_point8,d.ap5_point9,d.ap5_point10,d.ap5_point11,d.ap5_point12,d.ap5_point13,d.ap5_point14,d.ap5_point15,d.ap5_point16,d.ap5_point17,d.ap5_point18,d.ap5_point19,d.ap5_point20,d.ap5_point21,d.ap5_point22,d.ap5_point23,d.np5_indikator1,d.np5_indikator2,d.np5_indikator3,d.np5_indikator4,d.np5_indikator5,d.np5_indikator6,d.np5_indikator7,d.np5_total_skor,d.np5_persentase,d.np5_nilai_kompetensi
                                                            FROM tbl_penilaian AS a
                                                            JOIN tbl_periode AS b
                                                            JOIN tbl_guru AS c
                                                            JOIN pedagogik5 AS d
                                                            ...
                                                            AND a.guru_dinilai=c.nip
                                                            AND a.id_nilai=d.id_pedagogik5
                                                            WHERE d.id_pedagogik5=?")->execute($_GET["id"]));

			if ($data['np5_indikator1'] == '0') {
				$np5_indikator1 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator1'] == '1') {
				$np5_indikator1 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator1'] == '2') {
				$np5_indikator1 = 'Seluruhnya terpenuhi';
			}

			if ($data['np5_indikator2'] == '0') {
				$np5_indikator2 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator2'] == '1') {
				$np5_indikator2 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator2'] == '2') {
				$np5_indikator2 = 'Seluruhnya terpenuhi';
			}

			if ($data['np5_indikator3'] == '0') {
				$np5_indikator3 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator3'] == '1') {
				$np5_indikator3 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator3'] == '2') {
				$np5_indikator3 = 'Seluruhnya terpenuhi';
			}

			if ($data['np5_indikator4'] == '0') {
				$np5_indikator4 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator4'] == '1') {
				$np5_indikator4 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator4'] == '2') {
				$np5_indikator4 = 'Seluruhnya terpenuhi';
			}

			if ($data['np5_indikator5'] == '0') {
				$np5_indikator5 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator5'] == '1') {
				$np5_indikator5 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator5'] == '2') {
				$np5_indikator5 = 'Seluruhnya terpenuhi';
			}

			if ($data['np5_indikator6'] == '0') {
				$np5_indikator6 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator6'] == '1') {
				$np5_indikator6 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator6'] == '2') {
				$np5_indikator6 = 'Seluruhnya terpenuhi';
			}

			if ($data['np5_indikator7'] == '0') {
				$np5_indikator7 = 'Tidak terpenuhi';
			} elseif ($data['np5_indikator7'] == '1') {
				$np5_indikator7 = 'Terpenuhi sebagian';
			} elseif ($data['np5_indikator7'] == '2') {
				$np5_indikator7 = 'Seluruhnya terpenuhi';
			}
		?>
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="panel-body">
							<form class="form-horizontal tasi-form" action="modules/input_nilai/aksi_p5.php?mod=p5&act=nilai" method="POST" name="frmP5">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap1" class="form-control">
											<option value="<?php echo $data['ap5_point1']; ?>"><?php echo $data['ap5_point1']; ?></option>
											<option value="satu aspek">satu aspek</option>
											<option value="dua aspek">dua aspek</option>
											<option value="tiga aspek">tiga aspek</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap2" class="form-control">
											<option value="<?php echo $data['ap5_point2']; ?>"><?php echo $data['ap5_point2']; ?></option>
											<option value="tidak">tidak</option>
											<option value="cukup">cukup</option>
											<option value="sangat">sangat</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap3" class="form-control">
											<option value="<?php echo $data['ap5_point3']; ?>"><?php echo $data['ap5_point3']; ?></option>
											<option value="tidak">tidak</option>
											<option value="cukup">cukup</option>
											<option value="sangat">sangat</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap4" class="form-control">
											<option value="<?php echo $data['ap5_point4']; ?>"><?php echo $data['ap5_point4']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap5" class="form-control">
											<option value="<?php echo $data['ap5_point5']; ?>"><?php echo $data['ap5_point5']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap6" class="form-control">
											<option value="<?php echo $data['ap5_point6']; ?>"><?php echo $data['ap5_point6']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap7" class="form-control">
											<option value="<?php echo $data['ap5_point7']; ?>"><?php echo $data['ap5_point7']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									<label class="col-sm-10 col-sm-10 control-label">Dokumentasi dan bukti yang ada baik</label>
									<div class="col-sm-2">
										<select type="text" name="ap8" class="form-control">
											<option value="<?php echo $data['ap5_point8']; ?>"><?php echo $data['ap5_point8']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sangat">sangat</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap9" class="form-control">
											<option value="<?php echo $data['ap5_point9']; ?>"><?php echo $data['ap5_point9']; ?></option>
											<option value="ditingkatkan">ditingkatkan</option>
											<option value="dikembangkan">dikembangkan</option>
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap10" class="form-control">
											<option value="<?php echo $data['ap5_point10']; ?>"><?php echo $data['ap5_point10']; ?></option>
											<option value="satu aspek">satu aspek</option>
											<option value="dua aspek">dua aspek</option>
											<option value="tiga aspek">tiga aspek</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap11" class="form-control">
											<option value="<?php echo $data['ap5_point11']; ?>"><?php echo $data['ap5_point11']; ?></option>
											<option value="tidak">tidak</option>
											<option value="cukup">cukup</option>
											<option value="sangat">sangat</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap12" class="form-control">
											<option value="<?php echo $data['ap5_point12']; ?>"><?php echo $data['ap5_point12']; ?></option>
											<option value="tidak">tidak</option>
											<option value="cukup">cukup</option>
											<option value="sangat">sangat</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap13" class="form-control">
											<option value="<?php echo $data['ap5_point13']; ?>"><?php echo $data['ap5_point13']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap14" class="form-control">
											<option value="<?php echo $data['ap5_point14']; ?>"><?php echo $data['ap5_point14']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap15" class="form-control">
											<option value="<?php echo $data['ap5_point15']; ?>"><?php echo $data['ap5_point15']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap16" class="form-control">
											<option value="<?php echo $data['ap5_point16']; ?>"><?php echo $data['ap5_point16']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
								...
								<div class="form-group">
									...
									<div style="margin-bottom: 10px" class="col-sm-2">
										<select type="text" name="ap17" class="form-control">
											<option value="<?php echo $data['ap5_point17']; ?>"><?php echo $data['ap5_point17']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sangat">sudah</option>
										</select>
									...
									<div class="col-sm-2">
										<select type="text" name="ap18" class="form-control">
											<option value="<?php echo $data['ap5_point18']; ?>"><?php echo $data['ap5_point18']; ?></option>
											<option value="ditingkatkan">ditingkatkan</option>
											<option value="dikembangkan">dikembangkan</option>
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div style="margin-bottom: 10px" class="col-sm-2">
										<select type="text" name="ap19" class="form-control">
											<option value="<?php echo $data['ap5_point19']; ?>"><?php echo $data['ap5_point19']; ?></option>
											<option value="kurang">kurang</option>
											<option value="cukup">cukup</option>
											<option value="sudah">sudah</option>
										</select>
									...
									<div class="col-sm-2">
										<select type="text" name="ap20" class="form-control">
											<option value="<?php echo $data['ap5_point20']; ?>"><?php echo $data['ap5_point20']; ?></option>
											<option value="ditingkatkan">ditingkatkan</option>
											<option value="dikembangkan">dikembangkan</option>
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="ap21" class="form-control">
											<option value="<?php echo $data['ap5_point21']; ?>"><?php echo $data['ap5_point21']; ?></option>
											<option value="ditingkatkan">ditingkatkan</option>
											<option value="dikembangkan">dikembangkan</option>
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div style="margin-bottom: 10px" class="col-sm-2">
										<select type="text" name="ap22" class="form-control">
											<option value="<?php echo $data['ap5_point22']; ?>"><?php echo $data['ap5_point22']; ?></option>
											<option value="kurang baik">kurang baik</option>
											<option value="cukup baik">cukup baik</option>
											<option value="sudah baik">sudah baik</option>
										</select>
									...
									<div class="col-sm-2">
										<select type="text" name="ap23" class="form-control">
											<option value="<?php echo $data['ap5_point23']; ?>"><?php echo $data['ap5_point23']; ?></option>
											<option value="ditingkatkan">ditingkatkan</option>
											<option value="dikembangkan">dikembangkan</option>
										</select>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np1" class="form-control">
											<option value="<?php echo $data['np5_indikator1']; ?>"><?php echo $np5_indikator1; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np2" class="form-control">
											<option value="<?php echo $data['np5_indikator2']; ?>"><?php echo $np5_indikator2; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np3" class="form-control">
											<option value="<?php echo $data['np5_indikator3']; ?>"><?php echo $np5_indikator3; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np4" class="form-control">
											<option value="<?php echo $data['np5_indikator4']; ?>"><?php echo $np5_indikator4; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np5" class="form-control">
											<option value="<?php echo $data['np5_indikator5']; ?>"><?php echo $np5_indikator5; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np6" class="form-control">
											<option value="<?php echo $data['np5_indikator6']; ?>"><?php echo $np5_indikator6; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select type="text" name="np7" class="form-control">
											<option value="<?php echo $data['np5_indikator7']; ?>"><?php echo $np5_indikator7; ?></option>
											<option value="0">Tidak terpenuhi</option>
											<option value="1">Terpenuhi sebagian</option>
											<option value="2">Seluruhnya terpenuhi</option>
										</select>
