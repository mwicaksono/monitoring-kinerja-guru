    ...
    ?>
	                ...
	                <section class="panel">
	                    ...
	                    <div class="panel-body">
	                        <div class="alert alert-info alert-block fade in">
	                            ...
	                            <p style="font-size:15px">Kompetensi 9 : Menunjukan pribadi yang dewasa dan teladan.</p>
	                        </div>
	                        <div class="adv-table">
	                            <table class="display table table-striped table-bordered table-hover" id="example">
	                                ...
	                                <tbody>
                                        ...
                                        $sql = $db->database_prepare("SELECT a.id_nilai,a.periode_nilai,a.guru_dinilai,a.guru_penilai,a.angka_kredit,
                                                          ...
                                                          d.id_kepribadian2,d.nk2_indikator1,d.nk2_indikator2,d.nk2_indikator3,d.nk2_indikator4,d.nk2_indikator5,d.nk2_total_skor,d.nk2_persentase,d.nk2_nilai_kompetensi
                                                          FROM tbl_penilaian AS a
                                                          JOIN tbl_periode AS b
                                                          JOIN tbl_guru AS c
                                                          JOIN kepribadian2 AS d
                                                          ON a.periode_nilai=b.id_periode 
                                                          AND a.guru_dinilai=c.nip
                                                          AND a.id_nilai=d.id_kepribadian2
                                ...
                                <tr class='gradeX'>
                                    ...
                                    <td width='60' class='center'>$data[nk2_indikator1]</td>
                                    <td width='60' class='center'>$data[nk2_indikator2]</td>
                                    <td width='60' class='center'>$data[nk2_indikator3]</td>
                                    <td width='60' class='center'>$data[nk2_indikator4]</td>
                                    <td width='60' class='center'>$data[nk2_indikator5]</td>
                                    <td class='center'>$data[nk2_total_skor]</td>
                                    <td class='center'>$data[nk2_persentase] %</td>
                                    <td class='center'>$data[nk2_nilai_kompetensi]</td>";

                                            if ($data['nk2_nilai_kompetensi'] == '0' && $data['angka_kredit'] == '') {
                                                echo "
                                    <td width='100' class='center'>
                                        <a title='Penilaian' href='?module=k2&act=nilai&id=$data[id_nilai]'>
                                            <button class='btn btn-primary btn-xs'><i class='icon-edit'></i> Nilai</button>
                                        </a> 
                                    </td>";
                                            } elseif ($data['nk2_nilai_kompetensi'] != '0' && $data['angka_kredit'] == '') {
                                                echo "
                                    <td width='100' class='center'>
                                        <a title='Ubah' href='?module=k2&act=edit&id=$data[id_nilai]'>
	                        ...
	                        <form class="form-horizontal tasi-form" action="modules/input_nilai/aksi_k2.php?mod=k2&act=nilai" method="POST" name="frmK2">
	                            ...
	                            <div class="form-group">
	                                <div class="col-sm-2 pull-right">
	                                    ...
	                                    <a style="margin-left:10px;width:80px" href="?module=k2" class="btn btn-white"> Batal</a>
	                                </div>
	                            </div>
	                        </form>
	                    </div>
        ...
        case "edit":
            $data = $db->database_fetch_array($db->database_prepare("SELECT a.id_nilai,a.periode_nilai,a.guru_dinilai,a.guru_penilai,
                                                            b.id_periode,b.periode,
                                                            c.nip,c.nama_guru,c.gelar,
                                                            d.id_kepribadian2,d.ak2_point1,d.ak2_point2,d.ak2_point3,d.ak2_point4,d.ak2_point5,d.ak2_point6,d.ak2_point7,d.ak2_point8,d.ak2_point9,d.nk2_indikator1,d.nk2_indikator2,d.nk2_indikator3,d.nk2_indikator4,d.nk2_indikator5,d.nk2_total_skor,d.nk2_persentase,d.nk2_nilai_kompetensi
                                                            FROM tbl_penilaian AS a
                                                            JOIN tbl_periode AS b
                                                            JOIN tbl_guru AS c
                                                            JOIN kepribadian2 AS d
                                                            ...
                                                            AND a.guru_dinilai=c.nip
                                                            AND a.id_nilai=d.id_kepribadian2
                                                            WHERE d.id_kepribadian2=?")->execute($_GET["id"]));

            if ($data['nk2_indikator1'] == '0') {
                $nk2_indikator1 = 'Tidak terpenuhi';
            } elseif ($data['nk2_indikator1'] == '1') {
                $nk2_indikator1 = 'Terpenuhi sebagian';
            } elseif ($data['nk2_indikator1'] == '2') {
                $nk2_indikator1 = 'Seluruhnya terpenuhi';
            }

            if ($data['nk2_indikator2'] == '0') {
                $nk2_indikator2 = 'Tidak terpenuhi';
            } elseif ($data['nk2_indikator2'] == '1') {
                $nk2_indikator2 = 'Terpenuhi sebagian';
            } elseif ($data['nk2_indikator2'] == '2') {
                $nk2_indikator2 = 'Seluruhnya terpenuhi';
            }

            if ($data['nk2_indikator3'] == '0') {
                $nk2_indikator3 = 'Tidak terpenuhi';
            } elseif ($data['nk2_indikator3'] == '1') {
                $nk2_indikator3 = 'Terpenuhi sebagian';
            } elseif ($data['nk2_indikator3'] == '2') {
                $nk2_indikator3 = 'Seluruhnya terpenuhi';
            }

            if ($data['nk2_indikator4'] == '0') {
                $nk2_indikator4 = 'Tidak terpenuhi';
            } elseif ($data['nk2_indikator4'] == '1') {
                $nk2_indikator4 = 'Terpenuhi sebagian';
            } elseif ($data['nk2_indikator4'] == '2') {
                $nk2_indikator4 = 'Seluruhnya terpenuhi';
            }

            if ($data['nk2_indikator5'] == '0') {
                $nk2_indikator5 = 'Tidak terpenuhi';
            } elseif ($data['nk2_indikator5'] == '1') {
                $nk2_indikator5 = 'Terpenuhi sebagian';
            } elseif ($data['nk2_indikator5'] == '2') {
                $nk2_indikator5 = 'Seluruhnya terpenuhi';
            }
        ?>
	        <div class="row">
	            <div class="col-lg-12">
	                    ...
	                    <div class="panel-body">
	                        <form class="form-horizontal tasi-form" action="modules/input_nilai/aksi_k2.php?mod=k2&act=nilai" method="POST" name="frmK2">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak1" class="form-control">
	                                        <option value="<?php echo $data['ak2_point1']; ?>"><?php echo $data['ak2_point1']; ?></option>
	                                        <option value="kurang">kurang</option>
	                                        <option value="cukup">cukup</option>
	                                        <option value="sangat">sangat</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak2" class="form-control">
	                                        <option value="<?php echo $data['ak2_point2']; ?>"><?php echo $data['ak2_point2']; ?></option>
	                                        <option value="kurang">kurang</option>
	                                        <option value="cukup">cukup</option>
	                                        <option value="sangat">sangat</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak3" class="form-control">
	                                        <option value="<?php echo $data['ak2_point3']; ?>"><?php echo $data['ak2_point3']; ?></option>
	                                        <option value="kurang">kurang</option>
	                                        <option value="cukup">cukup</option>
	                                        <option value="sangat">sangat</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak4" class="form-control">
	                                        <option value="<?php echo $data['ak2_point4']; ?>"><?php echo $data['ak2_point4']; ?></option>
	                                        <option value="kurang">kurang</option>
	                                        <option value="cukup">cukup</option>
	                                        <option value="sangat">sangat</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak5" class="form-control">
	                                        <option value="<?php echo $data['ak2_point5']; ?>"><?php echo $data['ak2_point5']; ?></option>
	                                        <option value="kurang">kurang</option>
	                                        <option value="cukup">cukup</option>
	                                        <option value="sangat">sangat</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak6" class="form-control">
	                                        <option value="<?php echo $data['ak2_point6']; ?>"><?php echo $data['ak2_point6']; ?></option>
	                                        <option value="ditingkatkan">ditingkatkan</option>
	                                        <option value="dikembangkan">dikembangkan</option>
	                                    </select>
	                                </div>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak7" class="form-control">
	                                        <option value="<?php echo $data['ak2_point7']; ?>"><?php echo $data['ak2_point7']; ?></option>
	                                        <option value="tidak">tidak</option>
	                                        <option value="kadang-kadang">kadang-kadang</option>
	                                        <option value="selalu">selalu</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak8" class="form-control">
	                                        <option value="<?php echo $data['ak2_point8']; ?>"><?php echo $data['ak2_point8']; ?></option>
	                                        <option value="tidak">tidak</option>
	                                        <option value="kadang-kadang">kadang-kadang</option>
	                                        <option value="selalu">selalu</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="ak9" class="form-control">
	                                        <option value="<?php echo $data['ak2_point9']; ?>"><?php echo $data['ak2_point9']; ?></option>
	                                        <option value="tidak">tidak</option>
	                                        <option value="kadang-kadang">kadang-kadang</option>
	                                        <option value="selalu">selalu</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="nk1" class="form-control">
	                                        <option value="<?php echo $data['nk2_indikator1']; ?>"><?php echo $nk2_indikator1; ?></option>
	                                        <option value="0">Tidak terpenuhi</option>
	                                        <option value="1">Terpenuhi sebagian</option>
	                                        <option value="2">Seluruhnya terpenuhi</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="nk2" class="form-control">
	                                        <option value="<?php echo $data['nk2_indikator2']; ?>"><?php echo $nk2_indikator2; ?></option>
	                                        <option value="0">Tidak terpenuhi</option>
	                                        <option value="1">Terpenuhi sebagian</option>
	                                        <option value="2">Seluruhnya terpenuhi</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="nk3" class="form-control">
	                                        <option value="<?php echo $data['nk2_indikator3']; ?>"><?php echo $nk2_indikator3; ?></option>
	                                        <option value="0">Tidak terpenuhi</option>
	                                        <option value="1">Terpenuhi sebagian</option>
	                                        <option value="2">Seluruhnya terpenuhi</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="nk4" class="form-control">
	                                        <option value="<?php echo $data['nk2_indikator4']; ?>"><?php echo $nk2_indikator4; ?></option>
	                                        <option value="0">Tidak terpenuhi</option>
	                                        <option value="1">Terpenuhi sebagian</option>
	                                        <option value="2">Seluruhnya terpenuhi</option>
	                                    </select>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-2">
	                                    <select type="text" name="nk5" class="form-control">
	                                        <option value="<?php echo $data['nk2_indikator5']; ?>"><?php echo $nk2_indikator5; ?></option>
	                                        <option value="0">Tidak terpenuhi</option>
	                                        <option value="1">Terpenuhi sebagian</option>
	                                        <option value="2">Seluruhnya terpenuhi</option>
	                                    </select>
