    ...
    switch ($_GET['act']) {
        default:
    ?>
            <?php if ($_SESSION['level'] == 'Teman Sejawat') { ?>
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header style="font-size:18px" class="panel-heading">
                            <i style="margin-right:7px" class="icon-list-alt"></i> Hasil Penilaian Oleh Teman Sejawat
                        </header>
                        <div class="panel-body">
                            <?php
                            if ($_SESSION['level'] == 'Teman Sejawat') { ?>
                                <div class="adv-table">
                                    <table class="display table table-striped table-bordered table-hover" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            a.id_nilai, a.tanggal_nilai, a.periode_nilai, a.guru_dinilai, a.sejawat_penilai,
                                                          ...
                                                          WHERE a.sejawat_penilai='$_SESSION[id_user]'
                                ...
                                <tr class='gradeX'>
                                    ...
                                    <button class='btn btn-danger btn-xs'><i class='icon-exclamation'></i> Belum dinilai</button>
                                                    ...
                                                    echo "<a title='Cetak' href='modules/hasil_nilai/cetak_sejawat.php?id=$data[id_nilai]' target='_blank'>
