...
/* jika user sudah login, maka jalankan perintah untuk simpan, ubah dan hapus */ else {
    if ($_GET['mod'] == 'user' && $_GET['act'] == 'input') {
        ...
        if ($cekuser > 0) {
            header("Location: ../../dashboard.php?module=user&code=4");
        } else {
            ...
            header("Location: ../../dashboard.php?module=user&code=1");
        }
        ...
        if (empty($_POST['password'])) {
            ...
            header("Location: ../../dashboard.php?module=user&code=2");
        } else {
        ...
        header("Location: ../../dashboard.php?module=user&code=3");
    }
}
